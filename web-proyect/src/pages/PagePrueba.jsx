  ...
  return (
    <div className="relative z-0">
      ...
      <section className="px-6 py-30 bg-gradient-to-r from-[#B3C7FF] to-[#DFE162] text-center">
        <h1 className="text-4xl font-bold text-[#1C4390] mb-4">¡Bienvenido!</h1>
      ...
      <section className="px-6 py-12 bg-white">
        <h2 className="text-2xl font-semibold text-[#1C4390] mb-6">¿Por qué elegirnos?</h2>
      ...
      <section className="px-6 py-12 bg-[#DFE162] text-center">
        ...
        <p className="text-gray-800 mb-6">Únete a nuestra comunidad y mejora tu comodidad y experiencia.</p>
